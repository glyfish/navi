...
def contour(axis: axes.Axes,  f: NDArray[numpy.floating[Any]], x: NDArray[numpy.floating[Any]],  y: NDArray[numpy.floating[Any]], 
            values: NDArray[numpy.floating[Any]], **kwargs):
    """
...
def contour_hist(axis: axes.Axes, figure: figure.Figure, samples: NDArray[numpy.floating[Any]], f: NDArray[numpy.floating[Any]], x: NDArray[numpy.floating[Any]], 
                 y: NDArray[numpy.floating[Any]], values: NDArray[numpy.floating[Any]], **kwargs):
    """
